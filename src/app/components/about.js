    ...
    return (
        <>
            <div className="relative mt-16 md:hidden">
                <Image src={aboutmain} alt="" className="w-full h-full object-cover" />
                <div className="absolute inset-0 flex flex-col items-center justify-center text-black">
                    <h1 className="text-4xl font-bold">About us</h1>
                    <p className="text-center font-semibold text-[15px] mx-4 max-w-xl mt-4">
                        NACO envisions an India where every person living with HIV has access to quality care and is treated with dignity. Effective prevention, care and support for HIV/AIDS is possible in an environment where human rights are respected and where those infected or affected
                        by HIV/AIDS live a life without stigma and discrimination.
                    </p>
                </div>
            </div>
            ...
            <div className="relative w-full h-screen hidden md:flex">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center bg-opacity-50 z-10">
                    ...
                    <span className=" mx-[30%] text-2xl text-black text-center  bg-opacity-30 rounded">
